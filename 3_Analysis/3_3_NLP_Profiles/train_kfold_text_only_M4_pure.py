# ===============================
# train_kfold_text_only_M4_pure.py
# 基于 M2_pure 改造：
# 1) 输入文本列改为 text_M4
# 2) 不重新切分 train/val/test
# 3) 直接复用 M2_pure 已保存的 splits.csv
# 4) 数据文件从“脚本同文件夹”读取
# 5) 其余训练/评估逻辑与 M2 / M3 保持一致
# ===============================
...
# -----------------------
def main(
    data_file=os.path.join(BASE_DIR, "ML_dataset_balanced_5fold_text_M4_pure_depression.xlsx"),
    exp_root=os.path.join(BASE_DIR, "experiments"),
    exp_name="text_only_kfold_M4_pure",
